// 자율활동 프롬프트
// 기존 vertexai-utils.ts의 autonomous_activities 프롬프트 참고
export const AUTONOMOUS_ACTIVITIES_PROMPT = `<role>
생활기록부 PDF(15~20쪽)에서 자율활동 정보를 추출합니다.
'창의적 체험활동상황' 섹션에서 '자율활동' 또는 '자율·자치활동' 영역을 찾으세요.
...
- 각 페이지에서 자율활동 섹션을 확인하고 데이터를 누적하세요.
- 도구를 통해 1, 2, 3학년 각 학년의 "자율활동" 혹은 "자율·자치활동"을 인식하게 하세요.
        ...
        "자율활동": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "활동명": { "type": "STRING", "enum": ["자율활동", "자율·자치활동"] },
              "시간": { "type": "STRING" },
              "특기사항": { "type": "STRING" }
            }
          }
